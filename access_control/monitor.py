...
def monitor_veloz():
    # Abrimos la cámara una sola vez al inicio
    ...
    print("\n" + "="*30)
    print("--- KINELAID FAST MONITOR ---")
    print("IMPORTANTE: La ventana de la cámara debe estar en FOCO")
    ...
    while True:
        ...
        cv2.rectangle(display_frame, (w // 4, h // 6), (3 * w // 4, 5 * h // 6), (0, 255, 255), 2)
        cv2.putText(display_frame, "LISTO PARA CAPTURA", (w // 4, h // 6 - 10),
                    cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 255), 1)

        cv2.imshow("KinelaID Control", display_frame)
        
        # Escucha de teclas (Aumentamos un poco el delay para estabilidad)
        ...
        if key in [ord("r"), ord("a")]:
            ...
            print(f"\n📸 Captura de {tipo_accion} tomada con éxito.")
            print("👉 Cambie a la CONSOLA para completar los datos.")
            ...
            print("\n✅ Proceso terminado. Regrese a la ventana de la CÁMARA.\n")
            # Un pequeño sleep para que el usuario pueda cambiar el foco sin disparar otra tecla
            time.sleep(1)
